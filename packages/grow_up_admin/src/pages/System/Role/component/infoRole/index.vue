              ...
              <el-row :gutter="20">
                ...
                <el-col :span="8">
                  <GDetailItem label="角色类型" prop="roleType">
                    <template #default="{ value }">
                      <el-tag :type="['', 'warning'][value]">{{ (roleTypes.find(el => el.code === value) || {}).label }}</el-tag>
                    </template>
                  </GDetailItem>
                </el-col>
                <el-col :span="8">
                ...
                <el-col :span="8">
                  <GDetailItem label="启用状态" prop="state">
                    <template #default="{ value }">
                      <el-tag :type="['danger', 'success'][value]">{{ (roleStates.find(el => el.code === value) || {}).label }}</el-tag>
                    </template>
                  </GDetailItem>
                </el-col>
                <el-col :span="8">

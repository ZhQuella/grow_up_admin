<template>
  <div class="px-[10px] py-[5px]">
    <div class="relative w-full h-[150px]">
      ...
      <div class="absolute top-[5px] bottom-[5px] right-0 width-[0px] border-t-[transparent] border-b-[transparent] border-r-[#d6e4ff] border-t-[20px] border-b-[20px] border-r-[20px]">
      ...
      <div class="absolute bottom-0 left-0 right-0 h-[0px] border-l-[transparent] border-r-[transparent] border-b-[#d6e4ff] border-l-[20px] border-b-[20px] border-r-[20px]">
      ...
      <div class="absolute top-[5px] bottom-[5px] left-0 w-[0px] border-t-[transparent] border-b-[transparent] border-l-[#d6e4ff] border-t-[20px] border-b-[20px] border-l-[20px]">
      ...
      <div class="absolute top-[25px] left-[25px] right-[25px] h-[0px] border-t-[20px] border-r-[20px] border-l-[20px] border-t-[#d6e4ff] border-solid border-l-[transparent] border-r-[transparent]">
        <span class="absolute top-[-20px] left-0 right-0 h-[20px] bg-transparent w-full">
          <input placeholder="0"
                 maxlength="3"
                 height="100%"
      ...
      <div class="absolute top-[30px] bottom-[30px] right-[25px] w-[0px] border-t-[transparent] border-b-[transparent] border-r-[#d6e4ff] border-t-[20px] border-b-[20px] border-r-[20px]">
        <span class="absolute top-0 bottom-0 right-[-20px] w-[20px] m-[auto] bg-transparent">
          <input placeholder="0"
                 maxlength="3"
                 height="100%"
      ...
      <div class="absolute bottom-[25px] left-[25px] right-[25px] h-[0px] border-l-[transparent] border-r-[transparent] border-b-[#d6e4ff] border-l-[20px] border-b-[20px] border-r-[20px]">
      ...
      <div class="absolute top-[30px] bottom-[30px] left-[25px] w-[0px] border-t-[transparent] border-b-[transparent] border-l-[#d6e4ff] border-t-[20px] border-b-[20px] border-l-[20px]">
        <span class="absolute top-0 bottom-0 left-[-20px] w-[20px] m-[auto] bg-transparent">
          <input placeholder="0"
                 maxlength="3"
                 height="100%"
    ...
    <div class="flex pt-[5px]">
      <ElInput class="flex-1 mr-[4px]" size="small" placeholder="长度" :controls="false">
        <template #append>
          <ElSelect :modelValue="`px`" class="w-[50px]" size="small">
            <ElOption label="px" name="px"></ElOption>
            <ElOption label="%" name="%"></ElOption>
            <ElOption label="vh" name="vh"></ElOption>
          </ElSelect>
        </template>
      </ElInput>
      <ElInput class="flex-1 ml[4px]" size="small" placeholder="宽度" :controls="false">
        <template #append>
          <ElSelect :modelValue="`px`" class="w-[50px]" size="small">
            <ElOption label="px" name="px"></ElOption>
            <ElOption label="%" name="%"></ElOption>

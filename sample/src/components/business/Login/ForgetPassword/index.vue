<template>
  <div>
    ...
    <el-form ref="forgetFormRef" size="large" :rules="rules" :model="forgetForm">
      <el-form-item prop="account" class="enter-x">
        <el-input v-model="forgetForm.account" :placeholder="$t('LOGIN_WORD.ACCESS_MSG')" />
      </el-form-item>
      <el-form-item prop="phoneNumber" class="enter-x">
        <el-input v-model="forgetForm.phoneNumber" :placeholder="$t('LOGIN_WORD.MOBILE_PHONE')" />
      </el-form-item>
      <el-form-item prop="verificationCode" class="enter-x">
        <el-row class="w-full">
      ...
      <div class="pt-[10px] enter-x">
        <el-button type="primary" class="w-full" @click="onForgetPassword">

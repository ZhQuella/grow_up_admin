<template>
  <div class="flex flex-col">
    <div class="px-[5px]">
      <el-tabs v-model="activeName" @tab-change="onTableChange">
    ...
    <el-scrollbar class="h-full flex-1">
      <el-collapse v-model="collapseModel">
        <el-collapse-item v-for="item in drageMap" :title="item[1].title" :name="item[0]">
          <draggable
            v-model="item[1].group"
            :group="{
...
const { drageMap, activeName, collapseModel, onTableChange } = useInit();
